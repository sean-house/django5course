# Generated by Django 5.1.2 on 2024-11-08 18:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='article',
            name='status',
            field=models.CharField(choices=[('draft', 'draft'), ('inprogress', 'in progress'), ('published', 'published')], default='draft', max_length=50, verbose_name='status'),
        ),
        migrations.AlterField(
            model_name='article',
            name='title',
